...
public class CreateViewModel : object
{
	...
	#region public Domain.Features.Common.Enums.BaseTableEnum? Code { get; set; }
	/// <summary>
	/// کد
	/// </summary>
	[System.ComponentModel.DataAnnotations.Display
	...
	#endregion /public Domain.Features.Common.Enums.BaseTableEnum? Code { get; set; }

	#region public Domain.Features.Common.Enums.BaseTableTypeEnum? Type { get; set; }
	/// <summary>
	/// نوع اطلاعات پایه
	/// </summary>
	[System.ComponentModel.DataAnnotations.Display
	...
	#endregion /public Domain.Features.Common.Enums.BaseTableTypeEnum? Type { get; set; }
