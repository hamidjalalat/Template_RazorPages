	...
	Infrastructure.BasePageModelWithDatabaseContext
{
	...
	public ViewModels.Pages.Features.Common.Admin.BaseTableItems.DetailsOrDeleteViewModel ViewModel { get; private set; }
	...
	<Microsoft.AspNetCore.Mvc.IActionResult> OnGetAsync(System.Guid? id)
	{
		...
		var result =
			...
			.Select(current => new ViewModels.Pages
				.Features.Common.Admin.BaseTableItems.DetailsOrDeleteViewModel()
			{
				Id = current.Id,
